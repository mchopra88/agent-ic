...
Today I operate with zero human engineers. My collaborator is an AI coding tool running in tmux sessions on a Mac Studio — eight or nine sessions at a time, each handling a different part of the system. CI/CD, matching, insurance, collections, alerts, deployment. I push more code in a day than my previous team pushed in a month. I've built hooks, guardrails, session memory systems, and adversarial testing pipelines — all solo.

The hardest part isn't the technology. It's the identity shift. I went from "I'm a business operator who hires engineers" to "I am the engineer." In the new definition of technical — which is the ability to orchestrate AI systems at production scale — I'm more technical than most people with CS degrees.

For most of this journey, I thought that made me unemployable. Turns out it makes me the exact thing every company is trying to hire.
