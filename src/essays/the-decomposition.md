...
The [operating leverage essay](/essays/operating-leverage/) shows what this decomposition enables in practice: offshore agents generating 10x returns because they only handle the 20% of tasks that require being human, while the platform handles the other 80%.
